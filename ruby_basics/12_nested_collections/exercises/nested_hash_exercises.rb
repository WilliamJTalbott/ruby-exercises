...
def find_beautiful_languages(languages)
  ...
  languages.filter { |hash, info| info[:is_beautiful?] }
...
def find_language_facts(languages, language_name, fact_index = 0)
  ...
  # (now with additional facts added to each language with the
  # key :facts and value of an array of strings) 
  # 
  # Take languages and return the fact
